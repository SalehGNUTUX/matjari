    ...
    <div className="flex h-screen bg-gray-100 dark:bg-[#0a0f1a] overflow-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <aside className="hidden md:flex flex-col w-16 lg:w-56 bg-white dark:bg-[#111827] border-e border-gray-200 dark:border-white/5 shadow-sm flex-shrink-0 no-print">
        ...
        <div className="p-2 border-t border-gray-100 dark:border-white/5 hidden lg:block">
          <a href="https://github.com/SalehGNUTUX" target="_blank" rel="noopener noreferrer"
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0">
        ...
        {/* Mobile top bar */}
        <header className="md:hidden flex items-center justify-between px-4 py-2.5 bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-white/5 sticky top-0 z-40 no-print">
          <div className="flex items-center gap-2">
            <Logo size={24} />
        ...
        <div className="flex justify-around items-stretch py-1 px-1">
          {bottomNavItems.map(item => (
            <button key={item.id} onClick={() => setActiveTab(item.id)}
              className={`flex flex-col items-center justify-center gap-0.5 py-2 px-2 rounded-xl flex-1 transition-all ${
